...
parser.add_argument('-fp','--folder_path',required=True,help='Desired path to Morgan directory, without Morgan directory name')
parser.add_argument('-fn','--folder_name',required=True,help='Name of Morgan directory that will be created')
parser.add_argument('-tp','--t_pos',required=True,help='Number of processors for multiprocessing')
